...
MechaCar_mpg <- read.csv(file='Assignment Resources/MechaCar_mpg.csv',check.names=F,stringsAsFactors = F)
...
# Import CSV file:
Suspension_Coil <- read.csv(file='Assignment Resources/Suspension_Coil.csv',check.names=F,stringsAsFactors = F)
